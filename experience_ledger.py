...
class ExperienceLedger:
    ...
    def __init__(self):
        ...
        self.experiences = {
            "Language": [
                Experience("Language", "Lexer 구현", Verdict.IMPLEMENTED, 292, 79,
                ...
                Experience("Language", "Self-Hosting 컴파일러", Verdict.IMPLEMENTED, 154, 40,
                          "L4 Native ELF 고정점 달성 — SHA256 검증 (2026-05-24)"),
